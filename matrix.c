...
struct matrix * make_translate(double x, double y, double z) {
  struct matrix * new = new_matrix(4,4);
  ident(new);
  new->m[0][3] = x;
  new->m[1][3] = y;
  new->m[2][3] = z;
...
struct matrix * make_rotX(double theta) {
  struct matrix * new = new_matrix(4,4);
  ident(new);
  new->m[1][1] =  cos(theta * M_PI / 180);
  new->m[1][2] = -sin(theta * M_PI / 180);
  new->m[2][1] =  sin(theta * M_PI / 180);
  new->m[2][2] =  cos(theta * M_PI / 180);
  return new;
}
...
struct matrix * make_rotY(double theta) {
  ...
  ident(new);
  new->m[2][2] =  cos(theta * M_PI / 180);
  new->m[2][0] = -sin(theta * M_PI / 180);
  new->m[0][2] =  sin(theta * M_PI / 180);
  new->m[0][0] =  cos(theta * M_PI / 180);
  return new;
}
...
struct matrix * make_rotZ(double theta) {
  ...
  ident(new);
  new->m[0][0] =  cos(theta * M_PI / 180);
  new->m[0][1] = -sin(theta * M_PI / 180);
  new->m[1][0] =  sin(theta * M_PI / 180);
  new->m[1][1] =  cos(theta * M_PI / 180);
  return new;
}
